...
import { setQrBrightness } from '../platform/maxBridge';
...
export function T1TrustedHelpers() {
  ...
  const copy = async () => {
    ...
    try { await navigator.clipboard.writeText(pairing.data.deep_link); toast('Ссылка для близкого скопирована'); }
